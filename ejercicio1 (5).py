...
Original file is located at
    https://colab.research.google.com/drive/1iKsapYjPWDxRpkFXVjuNg0OB6Embv6Fe
"""
...
# Función dada
def f(x):
    return np.sin(x)  # Nueva función

# Derivada analítica
def df_analytical(x):
    return np.cos(x)  # Nueva derivada analítica
